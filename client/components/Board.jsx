...
function Board() {
  ...
  const fetchAndSort = async () => {
    let data = await fetch(`${BACKEND_URL}/api/board/${id}`, {
      method: "GET",
      credentials: "include",
    });
    ...
    <div>
      ...
      <body className='cards-container'>
        <div className='column'>
          ...
          {stories.map((story) => (
            <div className='cards'>
              ...
              <button
                ...
                onClick={() =>
                  addToDoBoard("new task", "TO_DO", 1, story.story_id)
                }
              >
                Add new
              </button>
          ...
          <button onClick={addStoryBoard} className='add-card-button'>
            Add New
          </button>
        </div>
        ...
        <div className='column'>
          ...
          <button onClick={addProcessBoard} className='add-card-button'>
            Add New
          </button>
        </div>
        ...
        <div className='column'>
          ...
          <button onClick={addValidationBoard} className='add-card-button'>
            Add New
          </button>
        </div>
        ...
        <div className='column'>
          ...
          <button onClick={addDoneBoard} className='add-card-button'>
            Add New
          </button>
        </div>
      </body>
